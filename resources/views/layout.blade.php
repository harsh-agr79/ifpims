...
<body class="has-fixed-sidenav">
    <header>
            ...
            <nav class="navbar white">
                <div class="nav-wrapper">
                    ...
                    <ul id="nav-mobile" class="right">
                        ...
                        <li>
                            {{-- <a href="#!" data-target="settings-dropdown" class="dropdown-trigger ">
        ...
        <ul id="sidenav-left" class="sidenav sidenav-fixed teal darken-3" style="transform: translateX(0%);">
            <li><a href="{{ url('/') }}" class="logo-container white-text">IMS IFP<i
                        class="material-icons left white-text">spa</i></a></li>
            <li class="no-padding">
